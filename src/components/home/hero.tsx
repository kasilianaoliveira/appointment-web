...
export default function Hero() {
  return (
    <section id="inicio" className="mx-auto flex w-full max-w-360 flex-col items-center gap-10 px-4 py-12 lg:flex-row md:items-center md:justify-between md:gap-12 md:py-16">
